...
// Mock data (mesmo de antes - não mudar)
...
export default function ClimderApp() {
  ...
  // Tela de Matches - ATUALIZADA COM CHAT
  const MatchesView = () => (
    <View style={styles.container}>
      <UserHeader />
  ...
  // Tela de Grupos - SEM MUDANÇAS AINDA
  const GroupsView = () => (
    <View style={styles.container}>
      <UserHeader />
        ...
        {groups.map((group) => (
          <View key={group.id} style={styles.groupCard}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => Alert.alert('Em breve!', 'Funcionalidade de participar em grupos será implementada na próxima versão.')}
            >
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.app}>
        ...
        {/* Chat Modal Simples - SEM ChatScreen externo por enquanto */}
        <Modal visible={showChat} animationType="slide" presentationStyle="fullScreen">
          <SafeAreaView style={styles.chatContainer}>
            <View style={styles.chatHeader}>
              <TouchableOpacity onPress={() => setShowChat(false)}>
                <Text style={styles.chatCloseText}>← Voltar</Text>
              </TouchableOpacity>
              <Text style={styles.chatTitle}>
                💬 Chat com {chatUser?.name || 'Escalador'}
              </Text>
            </View>
            
            <View style={styles.chatContent}>
              <Text style={styles.chatMessage}>🎉 Vocês fizeram match!</Text>
              <Text style={styles.chatSubMessage}>
                Sistema de chat completo será implementado na próxima versão.
              </Text>
              <Text style={styles.chatInfo}>
                Por enquanto, vocês podem se conectar através dos grupos de escalada! 🧗‍♀️
              </Text>
            </View>
          </SafeAreaView>
        </Modal>
